package net.flashpunk
{
	...
	public class Entity extends Tweener
	{
		...
		public function is_obj(obj:Object, type:Class):Boolean
		{
			if (obj == null) return false;
			return obj is Class(getDefinitionByName(getQualifiedClassName(type)));
		}
		
		public function is_a(type:Class):Boolean
		{
			return is_obj(this, type);
		}
		...
		public var const_hitbox_w:int = 0;
